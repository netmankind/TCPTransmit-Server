...
#include "../../api/tcptransmitclient.h"
...
QT_MOC_LITERAL(8, 99, 28) // "QAbstractSocket::SocketError"
    ...
    "TCPTransmitClient\0fileSizeSignal\0\0"
...
void TCPTransmitClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCPTransmitClient::fileSizeSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCPTransmitClient::messageSignal)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCPTransmitClient::transmitFinishedSignal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void TCPTransmitClient::fileSizeSignal(qint64 _t1)
{
...
// SIGNAL 1
void TCPTransmitClient::messageSignal(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void TCPTransmitClient::transmitFinishedSignal()
{
